...
public class PaymentResponse {
    ...
    private String clientSecret;        // Stripe client secret — frontend uses to render payment form
    private String publishableKey;      // Stripe publishable key — frontend uses to init Stripe.js
    private LocalDateTime createdAt;
    private String failureReason;

    public PaymentResponse() {}

    public PaymentResponse(String paymentId, String appointmentId, String doctorName,
